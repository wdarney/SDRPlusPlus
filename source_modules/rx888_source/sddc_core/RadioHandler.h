...
struct shift_limited_unroll_data_s;
typedef struct shift_limited_unroll_data_s rx888_fine_tune_data_t;
#else
struct shift_limited_unroll_C_sse_data_s;
typedef struct shift_limited_unroll_C_sse_data_s rx888_fine_tune_data_t;
#endif
...
private:
    ...
    rx888_fine_tune_data_t* stateFineTune;
};
