...
`21fa3d71` (based on `integration/main` at `b531c598`). The server change is now
in `integration/main`, and must be built with its matching core/source modules.
The iPhone change does not add multi-receiver support to older Android servers.
